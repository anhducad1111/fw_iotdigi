...
WifiCam wifiCam;  // WebServer for camera streaming
...
void setup() {
  ...
  // Initialize WebServer for camera streaming
  static WifiCam wifiCam;
  g_wifiCam = &wifiCam;
  g_wifiCam->init();

  // Create a FreeRTOS task for handling WiFi clients
  xTaskCreate(
    wifiCamTask,
    "WifiCamTask",
    4096,
